...
//   params: { slug: string };
// }) {
//   const journalsMeta: JournalMeta = {
//     title: "",
//     createdAt: "",
//     updatedAt: "",
//     author: "",
...
//     `src/content/journals/md/test.md`,
//     journalsMeta
//   );
//   const nodes = parseArticle(article);
//   return <article className="pt-1 pl-2 w-full">{nodes}</article>;
// }
...
//     });
//     reactNodes.push(
//       <section id={article.sectionId[index].id} key={"sec" + index}>
//         {blockNodes}
//       </section>
//     );
//     blockNodes = [];
